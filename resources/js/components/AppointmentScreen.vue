          ...
          <div class="col-lg-3 col-md-4 border-end">
            <div class="position-relative mt-5">
              ...
              <div class="
                        ...
                        flex-column
                      ">
                <img v-if="mentorDetails.image_path" :src="url + mentorDetails.image_path" alt=""
                  class="img-fluid position-relative" />
                <img v-else src="/assets/images/profile_placeholder.png" alt="" class="img-fluid position-relative" />
              </div>
            </div>
            ...
            <div class="d-flex justify-content-start flex-column ps-4">
              ...
              <p class="mb-0" v-for="category in mentorDetails.mentor.categories" :key="category.id">
                {{ category.name }}
              </p>
              <!-- <p class="mb-0">Business Consultant</p> -->
              <h6 class="text-secondary mb-0 mt-2">
                <i class="fa-solid fa-location-dot text-muted me-2"></i>{{ mentorDetails.user_country.name }}
              </h6>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-xxl-9 col-lg-8">
                  <div class="tab-content p-4 mt-lg-0 mt-4" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show" :id="'v-pills-' + schedule.appointment_type.name" role="tabpanel"
                      aria-labelledby="v-pills-home-tab" v-for="schedule in mentorDetails.schedule_types"
                      ...
                      <div class="row">
                        ...
                        ">
                          ...
                          <DatePicker input-class="form-control bg-primary ps-4 text-white selectdate"
                            :format="'dd-MM-yyyy'" :placeholder="'Select Date'" v-model="selected_date"
                            :highlighted="hightlight_days" v-on:input="
                              fetchAvailableSlots(
                                $event,
                        ...
                        <div v-if="availableSlots.length > 0" class="col-md-12 mt-4">
                          ...
                          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                              <button class="btn btn-shift mt-lg-0 mt-3 active" id="pills-morning-tab"
                                data-bs-toggle="pill" :data-bs-target="'#pills-morning' + schedule.appointment_type.name"
                                type="button" role="tab" aria-controls="pills-morning" aria-selected="true">
                                <i class="fa-solid fa-sun text-secondary me-2"></i>Morning
                              </button>
                            </li>
                            <li class="nav-item" role="presentation">
                              <button class="btn btn-shift mt-lg-0 mt-3" id="pills-afternoon-tab" data-bs-toggle="pill"
                                :data-bs-target="'#pills-afternoon' + schedule.appointment_type.name" type="button"
                                role="tab" aria-controls="pills-afternoon" aria-selected="false">
                                <i class="fa-solid fa-cloud text-info me-2"></i>Afternoon
                              </button>
                            </li>
                            <li class="nav-item" role="presentation">
                              <button class="btn btn-shift mt-lg-0 mt-3" id="pills-eve-tab" data-bs-toggle="pill"
                                :data-bs-target="'#pills-eve' + schedule.appointment_type.name" type="button" role="tab"
                                aria-controls="pills-eve" aria-selected="false">
                                <i class="fa-solid fa-moon text-primary me-2"></i>Evening
                              </button>
                            </li>
                          </ul>
                          <div class="tab-content border-0" id="pills-tabContent">
                            <div class="tab-pane fade show active" :id="'pills-morning' + schedule.appointment_type.name"
                              role="tabpanel" aria-labelledby="pills-morning-tab">
                              <div class="mt-4">
                                <div class="row slots-overflow">
                                  <div class="col-xl-3 col-lg-4 col-md-4 col-6"
                                    v-for="(slot, index) in sortedSlots.morning" :key="index">
                                    <button class="btn btn-slots w-100 mb-3" v-bind:class="{
                                      active:
                                        isActive == index &&
                                        selectedFrom == 'morning',
                                      'bg-danger':
                                        slot.is_booked
                                    }" v-if="slot.is_booked == 0" @click="selectedSlot(index, 'morning')">
                                      {{ slot.slot }}
                                    </button>
                                    <button class="btn btn-slots w-100 mb-3 text-danger" v-else>
                                      {{ slot.slot }}
                                    </button>
                                  </div>
                            ...
                            <div class="tab-pane fade" :id="'pills-afternoon' + schedule.appointment_type.name"
                              role="tabpanel" aria-labelledby="pills-afternoon-tab">
                              <div class="mt-4">
                                <div class="row slots-overflow">
                                  <div class="col-xl-3 col-lg-4 col-md-4 col-6"
                                    ...
                                    <button class="btn btn-slots w-100 mb-3 " v-bind:class="{
                                      ...
                                      'bg-danger':
                                        slot.is_booked
                                    }" v-if="slot.is_booked == 0" @click="selectedSlot(index, 'afternoon')">
                                      {{ slot.slot }}
                                    </button>
                                    <button class="btn btn-slots w-100 mb-3 text-danger" v-else>
                                      {{ slot.slot }}
                            ...
                            <div class="tab-pane fade" :id="'pills-eve' + schedule.appointment_type.name" role="tabpanel"
                                ...
                                <div class="row slots-overflow">
                                  <div class="col-xl-3 col-lg-4 col-md-4 col-6"
                                    ...
                                    <button class="btn btn-slots w-100 mb-3" v-bind:class="{
                                      ...
                                      'bg-danger':
                                        slot.is_booked
                                    }" v-if="slot.is_booked == 0" @click="selectedSlot(index, 'evening')">
                                      {{ slot.slot }}
                                    </button>
                                    <button class="btn btn-slots w-100 mb-3 text-danger" v-else>
                                      {{ slot.slot }}
                  ...
                  <div class="d-flex mt-4 justify-content-end align-items-center">
                    <button v-if="continue_btn" @click="loadAppointmentComponent()"
                      class="btn btn-secondary text-white px-4">
                      Continue
                      <i class="fa-solid fa-angles-right ms-1"></i>
                    </button>
                    <button v-if="appointment_chat" @click="loadAppointmentComponent()"
                      class="btn btn-secondary text-white px-4">
                      Continue
                      <i class="fa-solid fa-angles-right ms-1"></i>
                    </button>
